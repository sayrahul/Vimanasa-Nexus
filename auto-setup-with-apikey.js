/**
 * Automated Google Sheets Setup (Using API Key)
 * Alternative approach using API key instead of service account
 */
...
const API_KEY = 'AIzaSyDbCA4Jn1AHfan2Qpm4yuVpQqsVx93MRws';
const SERVICE_ACCOUNT_EMAIL = process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL;
const PRIVATE_KEY = process.env.GOOGLE_PRIVATE_KEY.replace(/\\n/g, '\n');

async function setupSheets() {
  console.log('🚀 Starting Automated Google Sheets Setup (API Key Method)\n');
  ...
  try {
    ...
    if (error.message.includes('unregistered callers')) {
      console.log('\n💡 Still getting authentication error. Let\'s try manual setup:');
      console.log('   Follow the guide: COPY_PASTE_SETUP.md (5 minutes)');
